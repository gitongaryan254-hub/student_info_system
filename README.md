...
if __name__ == "__main__":
    ...
    #result of this code 
    Name: malaso natipa 
Student ID: 2519886dai
Favorite AI or coding tool: python
Add another? yes/no: yes
Name: alex jason
Student ID: 2466895dai
Favorite AI or coding tool: vs code
Did you mean one of these?
1. vscode
Enter number to accept suggestion or press Enter to retry: 1
...
Saved_to_students.txt and students.json
